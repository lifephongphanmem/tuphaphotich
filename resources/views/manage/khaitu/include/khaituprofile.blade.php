        ...
        <div class="col-lg-12">
            <div class="table-responsive">
                ...
                <table class="table table-hover table-striped table-bordered table-advanced tablesorter display">
                    ...
                    <tr>
                        <td><b>Ngày sinh:</b>&nbsp;{{$khaitu->ngaysinh}}</td>
                    ...
                    <tr>
                        <td><b>Ngày chết:</b>&nbsp;{{$khaitu->ngaychet}}</td>
                    ...
                    <tr>
                        ...
                        <td><b>Ngày cấp giấy báo tử:</b>&nbsp;{{$khaitu->ngaycapgbt}}</td>
                    </tr>
                    <tr>
                        <td><b>Nơi đăng ký khai tử:</b>&nbsp;{{$khaitu->noidangkykt}}</td>
                        <td><b>Ngày đăng ký khai tử:</b>&nbsp;{{$khaitu->ngaydangkykt}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><b>Chức vụ:</b>&nbsp;{{$khaitu->chucvu}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><b>Tuổi người tử:</b>&nbsp;{{$khaitu->tuoinguoitu}}</td>
                    </tr>
                    </tbody>
                </table>
