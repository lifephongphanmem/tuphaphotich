        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8 controls">
                        {!!Form::text('ngaysinhchagiao',null, array('id' => 'ngaysinhchagiao','data-inputmask'=>"'alias': 'date'",'class' => 'form-control required'))!!}
                    </div>
                </div>
            </div>
        </div>
        <div class="rơw">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8 controls">
                        <select name="dantocchagiao" id="dantocchagiao" class="form-control required">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8 controls">
                        <select name="quoctichchagiao" id="quoctichchagiao" class="form-control required">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8 controls">
                        {!!Form::text('cmndchagiao', null, array('id' => 'cmndchagiao','class' => 'form-control', 'required'=>'required'))!!}
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8 controls">
                        {!!Form::text('noicapgtcg', null, array('id' => 'noicapgtcg','class' => 'form-control', 'required'=>'required'))!!}
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8 controls">
                        {!!Form::text('ngaycapgtcg',null, array('id' => 'ngaycapgtcg','data-inputmask'=>"'alias': 'date'",'class' => 'form-control required'))!!}
                    </div>
                </div>
            </div>
            <div class="col-md-6">
