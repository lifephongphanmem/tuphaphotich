...
<script>
    function ClickBC1(url){
        $('#frm_SoXNHN').attr('action',url);
        $('#frm_SoXNHN').submit();
    }
</script>

<!--Modal Thoại BC1-->
<div id="SoXNHN" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
    <div class="modal-dialog">
        {!! Form::open(['url'=>'/reports/sotthonnhan','target'=>'_blank' , 'id' => 'frm_SoXNHN', 'class'=>'form-horizontal form-validate']) !!}
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" data-dismiss="modal" class="btn btn-success" onclick="ClickBC1('/reports/sotthonnhan')">Đồng ý</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
